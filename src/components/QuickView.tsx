      ...
      <div className="quick-view" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="quick-view-grid">
          ...
          <div className="quick-details">
            ...
            <p className="quick-section-label">{t.quickView.whyYouLoveIt}</p>
            <p className="quick-section-text">{product.note}</p>
            <p className="quick-section-label">{t.quickView.howToUse}</p>
            ...
            <div className="quick-actions">
              ...
              <button
                ...
                aria-label={isWishlisted ? `${t.collection.removeWishlist}` : `${t.collection.saveWishlist}`}
            ...
            >
              {t.quickView.addToCart} <ShoppingBag size={15} />
            </button>
            <button
              className="button button-outline quick-buy-btn"
              onClick={() => onBuyNow(product, quantity)}
            >
              {t.quickView.buyNow} <ArrowRight size={15} />
            </button>
          </div>
        </div>
      </div>
